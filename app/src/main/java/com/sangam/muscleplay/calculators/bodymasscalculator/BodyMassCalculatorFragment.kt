...
class BodyMassCalculatorFragment : Fragment() {
    ...
    private lateinit var viewModel: ExtraDetailViewModel
    ...
    override fun onCreateView(
        ...
        viewModel = ViewModelProvider(requireActivity())[ExtraDetailViewModel::class.java]
        ...
        binding.spinnerWaist.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                when (selectedItemWaist) {
                    ...
                    "inch (in)" -> {
                        viewModel.changeToInchWaist()
                        binding.numberPickerWaist.minValue = 0
                        binding.numberPickerWaist.maxValue =
                            AppArrays.numbersArrayInch40130.size - 1
                        binding.numberPickerWaist.displayedValues = AppArrays.numbersArrayInch40130
                        numberPickerArrayWaist = AppArrays.numbersArrayInch40130
                    }
                }
            }
        ...
        binding.spinnerNeck.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                when (selectedItemNeck) {
                    ...
                    "inch (in)" -> {
                        viewModel.changeToInchNeck()
                        binding.numberPickerNeck.minValue = 0
                        binding.numberPickerNeck.maxValue = AppArrays.numbersArrayInch2080.size - 1
                        binding.numberPickerNeck.displayedValues = AppArrays.numbersArrayInch2080
                        numberPickerArrayNeck = AppArrays.numbersArrayInch2080
                    }
        ...
        binding.spinnerHip.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                when (selectedItemHip) {
                    ...
                    "inch (in)" -> {
                        viewModel.changeToInchHip()
                        binding.numberPickerHip.minValue = 0
                        binding.numberPickerHip.maxValue = AppArrays.numbersArrayInch40130.size - 1
                        binding.numberPickerHip.displayedValues = AppArrays.numbersArrayInch40130
                        numberPickerArrayHip = AppArrays.numbersArrayInch40130
                    }
